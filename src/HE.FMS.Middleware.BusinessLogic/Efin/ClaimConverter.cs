...
public class ClaimConverter : IClaimConverter
{
    ...
    public async Task<CLI_Invoice> CreateCliInvoice(ClaimPaymentRequest claimPayment)
    {
        ...
        return new CLI_Invoice()
        {
            ...
            cli_cfacs_customer = claimPayment.Organisation.Name,
            ...
            cli_description = string.Format(CultureInfo.InvariantCulture, "{0}{1}", claimPayment.Application.Name.TrimEnd(3), milestoneLookup[claimPayment.Claim.Milestone]),
    ...
    public async Task<CLA_InvoiceAnalysis> CreateClaInvoiceAnalysis(ClaimPaymentRequest claimPayment)
    {
        ...
        return new CLA_InvoiceAnalysis()
        {
            ...
            cla_description = string.Format(CultureInfo.InvariantCulture, "{0}{1}", claimPayment.Application.Name.TrimEnd(3), milestoneLookup[claimPayment.Claim.Milestone]),
