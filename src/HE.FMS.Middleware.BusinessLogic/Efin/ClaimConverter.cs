...
public class ClaimConverter : PaymentConverter, IClaimConverter
{
    ...
    public async Task<CLI_Invoice> CreateCliInvoice(ClaimPaymentRequest claimPayment)
    {
        ...
        return new CLI_Invoice()
        {
            ...
            cli_date = claimPayment.Claim.ApprovedOn.ToString(DateAndTimeFormat, CultureInfo.InvariantCulture),
            ...
            cli_due_date = claimPayment.Claim.ApprovedOn.AddDays(7).ToString(DateAndTimeFormat, CultureInfo.InvariantCulture),
