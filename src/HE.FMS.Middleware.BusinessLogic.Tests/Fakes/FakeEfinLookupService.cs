    ...
    public Task<Dictionary<string, string>> GetValue(string key)
    {
        ...
        else if (key.Equals(EfinConstants.Lookups.PartnerTypeLookup, StringComparison.OrdinalIgnoreCase))
        {
            dictionary = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                { "Claim_Capital_ForProfitRegisteredProvider", "1558" },
                ...
                { "Claim_Capital_Landowner_134370003", "1551" },
                { "Claim_Capital_Landowner_134370023", "1551" },
                ...
                { "Claim_Revenue_ForProfitRegisteredProvider", "1559" },
                ...
                { "Claim_Revenue_Landowner_134370003", "1575" },
                { "Claim_Revenue_Landowner_134370023", "1575" },
                ...
                { "Reclaim_Amount_ForProfitRegisteredProvider", "0030" },
                ...
                { "Reclaim_Amount_Landowner_134370003", "0029" },
                { "Reclaim_Amount_Landowner_134370023", "0029" },
                ...
                { "Reclaim_InterestAmount_ForProfitRegisteredProvider", "0067" },
                ...
                { "Reclaim_InterestAmount_Landowner_134370003", "0067" },
                { "Reclaim_InterestAmount_Landowner_134370023", "0067" },
