...
public class CLI_IW_BAT
{
    ...
    public static CLI_IW_BAT Create(IEnumerable<ReclaimItem> reclaimItems)
    {
        ArgumentNullException.ThrowIfNull(reclaimItems);
        ...
        return new CLI_IW_BAT()
        {
            ...
            cliwb_no_invoices = reclaimItems.Count().ToString(CultureInfo.InvariantCulture),
